<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NumSwapWithoutThirdVariable.aspx.cs" Inherits="SwappingProgram.NumSwapWithoutThirdVariable" %>
...
<body>
    <form id="form1" runat="server">
        <div>
                &nbsp;
            <asp:Label ID="Label9" runat="server" Font-Bold="True" Font-Names="Cascadia Mono" Text="Swapping Program Without third variable:"></asp:Label>
            <br />
            <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
